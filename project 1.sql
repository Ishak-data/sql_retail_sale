...
SELECT COUNT(*) AS tot_rows FROM retail_sales;--1997
...
SELECT COUNT(DISTINCT quantity) AS no_of_quantity FROM retail_sales;

SELECT COUNT(DISTINCT price_per_unit) AS tot_unit_price FROM retail_sales;
...
SELECT month,year,avg_sale,rank FROM
						(SELECT 
